...
const Footer = () => {
  return (
    ...
    <footer className="footer p-10 bg-[#3b4149] ">
  <div>
  ...
  <div>
    ...
    <div className="form-control w-96 bg-slate-600 border-none">
      <label className="label">
        <span className="label-text text-white">Enter your email address</span>
      </label> 
      <div className="relative">
        <input type="text" placeholder="username@site.com" className="input input-bordered w-full pr-16 bg-slate-400" /> 
